...
#include <TKDT_2023_inferencing.h>
...
void loop() {
  ...
  if (ei_sleep(5) != EI_IMPULSE_OK) {
    ...
    for (size_t ix = 0; ix < result.bounding_boxes_count; ix++) {
        ...
        if(bb.label=="mouse" && bb.value>0.9 && check && check1){
          String a="100000";
          uint8_t data[a.length()];
            for (size_t i = 0; i < a.length(); i++) {
                data[i] = static_cast<uint8_t>(a.charAt(i));
          ...
          else if(bb.label=="mangoes" && bb.value>0.8 && check2){
          String a="9325";
          uint8_t data[a.length()];
            for (size_t i = 0; i < a.length(); i++) {
                data[i] = static_cast<uint8_t>(a.charAt(i));
          ...
          else if(bb.label=="apple" && bb.value>0.8 && check && check3){
          String a="3520";
          uint8_t data[a.length()];
            for (size_t i = 0; i < a.length(); i++) {
                data[i] = static_cast<uint8_t>(a.charAt(i));
